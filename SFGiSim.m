...
% Last Modified by GUIDE v2.5 29-Oct-2014 12:22:29
...
function edit_dispName_Callback(hObject, eventdata, handles)
% hObject    handle to edit_dispName (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of edit_dispName as text
%        str2double(get(hObject,'String')) returns contents of edit_dispName as a double


% --- Executes during object creation, after setting all properties.
function edit_dispName_CreateFcn(hObject, eventdata, handles)
% hObject    handle to edit_dispName (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
